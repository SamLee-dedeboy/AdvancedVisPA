...
class HistogramView extends WebGLView {
    ...
    renderBars() {
        ...
        this.render2d(new Float32Array(lines), {xMin: -this.barStartX, yMin: -this.barStartY, xMax: this.canvasWidth(), yMax: this.canvasHeight() - this.barStartY}, [0,0,255,1], this.gl.TRIANGLES)
    }
    renderLabels() {
    ...
    //     this.model = new HistogramModel(data, nBins)
    //     if(this.rendered) {
    //         this.clear([255,255,255])
    //         this.clearCanvas()
    //         this.render()
