...
class VolView3d extends Canvas2dView
{
    ...
    // TODO --- the take as input a coordinate in data space as [ x, y, z ]
    // transform the position into a screen space coordinate [ sx, sy ]
    // (the coordinates of the canvas/widget in pixel space with (0,0) in
    // the upper left corner
    dataSpacePositionToScreenSpacePos( dims, pos )
    {
        var posVector = glMatrix.vec4.fromValues( pos[ 0 ], pos[ 1 ], pos[ 2 ], 1.0 )
        var toClipSpace = this.dataSpaceToClipSpace(dims)
